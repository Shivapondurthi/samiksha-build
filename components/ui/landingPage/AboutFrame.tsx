...
const AboutFrame: React.FC = () => {
    ...
    return (
        <main className="relative pt-24 mx-auto my-0 w-full bg-white ">
            {/* About Header */}
            <header className="flex items-center justify-between px-28 py-0 mb-12 max-md:flex-col max-md:px-5 max-md:text-center">
                ...
                >
                    ...
                    <div className="flex flex-col pr-10 left-0">
                        ...
                        <h2 className="text-4xl font-extrabold tracking-wider max-sm:text-3xl mt-3 text-black">SAMIKSHA ACADEMY</h2>
                    </div>
                </motion.div>
                ...
                >
                    <h2 className="text-4xl font-extrabold tracking-wider max-w-[481px] max-md:my-5 max-sm:text-3xl">
                        ...
                        <span className="text-black"> and Stand Out from the Rest!</span>
                    </h2>
                    <motion.button
            ...
            <h2 className="mt-10 text-5xl font-extrabold text-center max-sm:text-4xl text-black">
                Nataraj Pydi
            </h2>
            ...
            <section className="p-14 mt-10 bg-[#7A81941A] bg-opacity-10 rounded-[50px]">
                ...
                <article className="mt-10 text-center">
                    <h2 className="mb-5 text-4xl font-black max-sm:text-3xl text-black">
                        WHY SAMIKSHA ACADEMY?
                    </h2>
                    <p className="mx-auto my-0 text-xl font-medium leading-normal max-w-[971px] max-sm:text-base text-black">
                        ...
                        competitors, and let &apos s build our nation ready for social, economic,
